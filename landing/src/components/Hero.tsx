    ...
    <section className="hero">
      <div className="container hero-grid">
        <div className="hero-copy">
          <p className={`eyebrow reveal ${mounted ? "in-view" : ""}`}>
            Lingguang · Desktop Toolbox
          </p>
          <h1 className="hero-title">
            <span className={cls("hero-line")}>把繁琐的文件处理，</span>
            <span className={cls("hero-line hero-line-2")}>
              交给<em>灵光</em>
            </span>
          </h1>
          ...
          <div className={`hero-actions reveal ${mounted ? "in-view" : ""}`}>
            ...
            <a className="btn btn-ghost btn-lg" href="#tools">
              了解功能
            </a>
          </div>
        ...
        <div className={`hero-visual reveal ${mounted ? "in-view" : ""}`}>
          ...
          <span className="float-chip chip-b">v{version} · Mac / Win</span>
        </div>
      </div>
